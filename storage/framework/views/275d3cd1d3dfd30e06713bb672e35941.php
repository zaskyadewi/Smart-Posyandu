    ...
    <div class="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-12 border border-slate-200/80">
        ...
        <div class="md:col-span-7 p-8 sm:p-12 flex flex-col justify-center bg-white">
            ...
            <div class="bg-slate-100 p-1 rounded-xl inline-flex mb-8 self-start border border-slate-200/60">
                <a href="<?php echo e(route('login')); ?>" class="bg-white text-blue-600 font-bold shadow-sm px-6 py-2 rounded-lg text-sm transition">
                    Masuk
                </a>
                <?php if(Route::has('register')): ?>
                    <a href="<?php echo e(route('register')); ?>" class="text-slate-600 hover:text-slate-900 font-semibold px-6 py-2 rounded-lg text-sm transition">
                        Daftar
                    </a>
                <?php endif; ?>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="contoh: kader@email.com" 
                ...
                <div class="flex items-center justify-between pt-1">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-bold text-blue-600 hover:text-blue-800 hover:underline transition">
                            Lupa Sandi?
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="mt-8 text-center border-t border-slate-100 pt-6">
                <a href="<?php echo e(url('/')); ?>" class="text-xs font-semibold text-slate-400 hover:text-slate-600 transition inline-flex items-center gap-1">
...
</html><?php /**PATH C:\Users\donaf\Smart-Posyandu\resources\views/auth/login.blade.php ENDPATH**/ ?>