                        ...
                        <div class="flex items-center gap-3">
                            <?php if(auth()->guard()->check()): ?>
                                <span class="hidden sm:inline-block text-sm font-bold text-slate-700">
                                    Halo, <span class="text-blue-600"><?php echo e(Auth::user()->name); ?></span>
                                </span>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="font-bold text-slate-700 hover:text-blue-600 px-4 py-2.5 rounded-xl text-sm transition">
                                    Login
                                </a>
                                <?php if(Route::has('register')): ?>
                                    <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold px-5 py-2.5 rounded-xl text-sm shadow-sm transition">
                                        Daftar Akun
                                    </a>
                                <?php endif; ?>
                            <?php endif; ?>
    ...
    <div class="max-w-6xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-3xl border-2 border-blue-600 shadow-xl p-6 sm:p-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <a href="<?php echo e(route('balita.index')); ?>" class="p-5 rounded-2xl border border-slate-200 hover:border-blue-500 hover:shadow-md transition bg-slate-50 hover:bg-white flex items-center gap-4 group">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 font-medium mt-0.5">
                            <?php if(Auth::user()->role === 'kader'): ?> + Tambah & Kelola Data <?php else: ?> Lihat Daftar Anak <?php endif; ?>
                        </p>
                    </div>
                </a>

                <a href="<?php echo e(route('pemeriksaan.index')); ?>" class="p-5 rounded-2xl border border-slate-200 hover:border-blue-500 hover:shadow-md transition bg-slate-50 hover:bg-white flex items-center gap-4 group">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 font-medium mt-0.5">
                            <?php if(Auth::user()->role === 'kader'): ?> + Input Timbangan & AI <?php else: ?> Lihat Status Gizi & KMS <?php endif; ?>
                        </p>
                    </div>
                </a>

                <a href="<?php echo e(route('pemeriksaan.cetak')); ?>" target="_blank" class="p-5 rounded-2xl border border-slate-200 hover:border-blue-500 hover:shadow-md transition bg-slate-50 hover:bg-white flex items-center gap-4 group">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
                ...
                <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center bg-white hover:bg-slate-50 text-slate-800 font-bold px-8 py-4 rounded-xl border border-slate-300 shadow-sm text-base transition">
                            Masuk Sekarang
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
    ...
    <footer id="kontak" class="bg-white border-t border-slate-200/80 pt-16 pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            ...
            <div class="text-slate-400 text-sm font-medium">
                &copy; <?php echo e(date('Y')); ?> Smart-Posyandu. Dibuat untuk Generasi Sehat Indonesia.
            </div>
        </div>
    </footer>

</body>
</html><?php /**PATH C:\Users\donaf\Smart-Posyandu\resources\views/welcome.blade.php ENDPATH**/ ?>