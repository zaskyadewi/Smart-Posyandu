    ...
    <div class="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-12 border border-slate-200/80 my-8">
        ...
        <div class="md:col-span-7 p-8 sm:p-12 flex flex-col justify-center bg-white">
            ...
            <div class="bg-slate-100 p-1 rounded-xl inline-flex mb-8 self-start border border-slate-200/60">
                <a href="<?php echo e(route('login')); ?>" class="text-slate-600 hover:text-slate-900 font-semibold px-6 py-2 rounded-lg text-sm transition">
                    Masuk
                </a>
                <a href="<?php echo e(route('register')); ?>" class="bg-white text-blue-600 font-bold shadow-sm px-6 py-2 rounded-lg text-sm transition">
                    Daftar
                </a>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus placeholder="contoh: Sarwendah, S.Tr.Keb" 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="contoh: kader@email.com" 
                            class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-300 rounded-xl font-medium text-slate-800 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent text-sm transition">
                    </div>
                </div>
...
</html><?php /**PATH C:\Users\donaf\Smart-Posyandu\resources\views/auth/register.blade.php ENDPATH**/ ?>